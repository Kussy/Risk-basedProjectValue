...
namespace Kussy.Analysis.Project.Core
{
    ...
    public class TestEPCProject
    {
        ...
        {
            project = Create();
            a_12BD01 = project.Activities.First(a => a.Code == "12BD01");
            a_01CS01 = project.Activities.First(a => a.Code == "01CS01");
            a_15DE01 = project.Activities.First(a => a.Code == "15DE01");
            a_17DE01 = project.Activities.First(a => a.Code == "17DE01");
            a_12BD02 = project.Activities.First(a => a.Code == "12BD02");
            a_16BD01 = project.Activities.First(a => a.Code == "16BD01");
            a_14DE01 = project.Activities.First(a => a.Code == "14DE01");
            a_15DE02 = project.Activities.First(a => a.Code == "15DE02");
            a_17DE02 = project.Activities.First(a => a.Code == "17DE02");
            a_16PR01 = project.Activities.First(a => a.Code == "16PR01");
            a_16DE01 = project.Activities.First(a => a.Code == "16DE01");
            a_15PR01 = project.Activities.First(a => a.Code == "15PR01");
            a_14PR01 = project.Activities.First(a => a.Code == "14PR01");
            a_16DE02 = project.Activities.First(a => a.Code == "16DE02");
            a_13DE01 = project.Activities.First(a => a.Code == "13DE01");
            a_16DE03 = project.Activities.First(a => a.Code == "16DE03");
            a_13CS01 = project.Activities.First(a => a.Code == "13CS01");
            a_17PR01 = project.Activities.First(a => a.Code == "17PR01");
            a_13CS02 = project.Activities.First(a => a.Code == "13CS02");
            a_14CS01 = project.Activities.First(a => a.Code == "14CS01");
            a_16CS01 = project.Activities.First(a => a.Code == "16CS01");
            a_16CS02 = project.Activities.First(a => a.Code == "16CS02");
            a_15CS01 = project.Activities.First(a => a.Code == "15CS01");
            a_16CS03 = project.Activities.First(a => a.Code == "16CS03");
            a_17CS01 = project.Activities.First(a => a.Code == "17CS01");
            a_12CM01 = project.Activities.First(a => a.Code == "12CM01");
        }
        ...
        private static Project Create()
        {
            ...
            var a_12BD01 = Activity.Define(code: "12BD01", name: "Process design - basic", fixTime: 3m);
            var a_01CS01 = Activity.Define(code: "01CS01", name: "Site Preparation", fixTime: 13.5m);
            var a_15DE01 = Activity.Define(code: "15DE01", name: "Equipment eng & vendor selection", fixTime: 4m);
            var a_17DE01 = Activity.Define(code: "17DE01", name: "E&I engineering - development", fixTime: 5.5m);
            var a_12BD02 = Activity.Define(code: "12BD02", name: "Process enginnering - development", fixTime: 7m);
            var a_16BD01 = Activity.Define(code: "16BD01", name: "Plant layout & piping engineering", fixTime: 5.5m);
            var a_14DE01 = Activity.Define(code: "14DE01", name: "Structure engineering", fixTime: 5m);
            var a_15DE02 = Activity.Define(code: "15DE02", name: "Equipment vendor eng & review", fixTime: 2m);
            var a_17DE02 = Activity.Define(code: "17DE02", name: "E&I vendor eng & review", fixTime: 2m);
            var a_16PR01 = Activity.Define(code: "16PR01", name: "Piping mat'l procurement & shipping 1st", fixTime: 10m);
            var a_16DE01 = Activity.Define(code: "16DE01", name: "3D modeling", fixTime: 2m);
            var a_15PR01 = Activity.Define(code: "15PR01", name: "Equipment manufacturing & shipping", fixTime: 14m);
            var a_14PR01 = Activity.Define(code: "14PR01", name: "Steel structure fabrication & shipping 1st", fixTime: 7m);
            var a_16DE02 = Activity.Define(code: "16DE02", name: "3D model review", fixTime: 1m);
            var a_13DE01 = Activity.Define(code: "13DE01", name: "Civil & pipe rack foundation engineering", fixTime: 1m);
            var a_16DE03 = Activity.Define(code: "16DE03", name: "Piping ISO drawing production 1st", fixTime: 6m);
            var a_13CS01 = Activity.Define(code: "13CS01", name: "Civil & pipe rack foundation construction", fixTime: 5m);
            var a_17PR01 = Activity.Define(code: "17PR01", name: "E&I manufacturing & shipping", fixTime: 15m);
            var a_13CS02 = Activity.Define(code: "13CS02", name: "Other civil & foundation constr.", fixTime: 7m);
            var a_14CS01 = Activity.Define(code: "14CS01", name: "Steel structure construction 1st", fixTime: 5m);
            var a_16CS01 = Activity.Define(code: "16CS01", name: "Piping prefabrication 1st", fixTime: 4.5m);
            var a_16CS02 = Activity.Define(code: "16CS02", name: "Piping on rack installation", fixTime: 6m);
            var a_15CS01 = Activity.Define(code: "15CS01", name: "Equipment erection", fixTime: 4m);
            var a_16CS03 = Activity.Define(code: "16CS03", name: "Piping a/Eq. installation", fixTime: 6m);
            var a_17CS01 = Activity.Define(code: "17CS01", name: "E&I a/Eq. construction", fixTime: 6m);
            var a_12CM01 = Activity.Define(code: "12CM01", name: "Pre-comm. & commissioning", fixTime: 6m);
